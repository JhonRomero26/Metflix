  ...
  card.innerHTML = `
    ...
    <div class="carousel-details">
      <div class="buttons-contact">
        ...
        <img src="/assets/img/icons8-play-64.png" alt="Ver pelicula" srcset="">
        </a>
        <img src="/assets/img/icons8-plus-64.png" alt="Agregar" srcset="">
      </div>
  ...
  modal.innerHTML = `
    ...
    <div class="modal">
      <div class="modal-content">
        <img src="${movie.medium_cover_image}" alt="${movie.title} poster" width="170" height="256">
        <h2>${movie.title}</h2>
        <p>${movie.synopsis}</p>
      </div>
